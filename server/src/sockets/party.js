...
function setPartyVideoPlayerState ( io, socket, payload ) {
	...
	if ( !party.isWaitingToBeReady ( partyId ) && party.isValidNewPlayerStateForParty ( partyId, { playerState, timeInVideo } ) ) {
		...
		if ( playerState === 'paused' ) {
			...
			socketUtils.broadcastActionToParty ( socket, partyId, ACTION_TYPES.SET_PARTY_PLAYER_STATE, {
				playerState: 'paused',
				timeInVideo
			} )
